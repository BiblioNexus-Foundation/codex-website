...
<footer class="p-4 mx-auto text-center max-w-xl">
  <div
    class="flex w-full flex-col justify-between space-y-4 md:flex-row md:items-center md:space-y-0"
  >
    <div class="flex w-full flex-row justify-between md:w-1/4">
      <img src="./public/bible-logo.png" class="h-16 w-16" alt="Bible Logo" />
    </div>
    <div>
        ...
        >
          <li>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer">Conceptual Documentation</a
            >
          </li>
          <li>
            <a
