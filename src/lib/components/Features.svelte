...
<div class="mx-auto w-full rounded-xl bg-neutral-100 p-4 md:p-6">
  <div class="flex w-full flex-col items-center space-y-8 py-8 text-center md:space-y-12 md:py-16">
    <div class="flex max-w-xl flex-col space-y-2">
      <h1 class="text-2xl font-semibold leading-snug text-neutral-900 md:text-3xl lg:text-4xl">
    ...
    <div class="flex flex-col space-y-6 md:space-y-10">
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 max-w-6xl">
        <FeatureCard
          icon="message-circle"
